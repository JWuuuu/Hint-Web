...
import { AppGateCTA, LockedInsightCard, OpenAppButton, PreviewTextBlock, ViewMoreGate } from "../../components/app/AppGate";
  ...
  return (
    <AppScreen>
      ...
      <div className="grid gap-4">
        ...
        <Link className="font-sans text-[13px] font-semibold" style={{ color: "var(--hint-muted)" }} href="/app">
          ← Back to web preview
        </Link>
      </div>
    </AppScreen>
