  ...
  return (
    <div ref={rootRef} className={`pointer-events-auto relative ${className || "inline-flex"}`}>
      <button
        ...
        className={
          compact
            ? "inline-flex size-9 items-center justify-center rounded-full border px-0 font-sans text-[11px] font-black uppercase tracking-normal transition-colors lg:size-11 lg:text-[12px]"
      ...
      >
        {compact ? (
          <span className="leading-none" style={{ color: "var(--hint-text)" }}>
