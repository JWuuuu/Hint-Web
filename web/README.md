...
Hint Web is a Vite React website with a lightweight Node/Express API workspace,
generated API clients, and a Postgres-backed Drizzle schema for preview/demo data.

## Code layout

This repo stays as one pnpm workspace, but the website is organized as separate
frontend and backend packages:

- `artifacts/hint` - frontend React/Vite website.
...
- Frontend website deploys to Vercel from `artifacts/hint/dist/public`.
