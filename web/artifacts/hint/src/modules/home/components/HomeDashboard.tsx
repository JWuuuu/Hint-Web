...
import { OpenAppButton } from "../../../components/web/AppGate";
          ...
          <div>
            ...
            {revealed && (
              <button
                ...
                className="inline-flex h-9 items-center justify-center rounded-full border px-4 font-sans text-[12px] font-semibold leading-none transition hover:translate-y-[-1px]"
                style={{
                  color: "var(--hint-text)",
        ...
        {revealed && expanded && (
          ...
          >
            ...
            >
              ...
              <OpenAppButton appPath="/ask" className="mt-4 w-full sm:w-auto">
...
function PatternPanel() {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          [t("home.stat.readings"), "Lite"],
          [t("home.stat.pages"), "Locked"],
          [t("home.stat.pulls"), "App"],
        ].map(([label, value]) => (
          <div
            key={label}
