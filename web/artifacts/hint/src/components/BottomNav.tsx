...
import type { HintTheme } from "./web/theme";
import { useLanguage } from "../lib/i18n";
import { HintLogo } from "./web/HintLogo";
...
export function BottomNav({ theme, onThemeToggle }: BottomNavProps) {
  ...
  const navItems = [
    ...
    { href: "/preview#rewards", label: t("nav.rewards"), section: true },
  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="/preview"
          aria-current={location === "/preview" ? "page" : undefined}
          data-active={location === "/preview" ? "true" : "false"}
          ...
          style={{
            ...
            background: location === "/preview"
              ...
              : "transparent",
            borderColor: location === "/preview"
              ? isDark
                ? "rgba(241,166,107,0.35)"
                : "rgba(116,89,58,0.14)"
              : "transparent",
            boxShadow: location === "/preview"
              ? isDark
